...
namespace steamvrbridge {
	...
	//==================================================================================================
	#ifdef WIN32
	std::string Win32Utils::GetLastErrorAsString()
	{
    ...
    bool StringUtils::ConvertWideToMultiByte(const wchar_t *wc_string, char *out_mb_serial, const size_t mb_buffer_size)
    {
        bool success= false;
	...
	int StringUtils::FindIndexInTable(const char **string_table, const int string_table_count, const char *string) {
		int result_index = -1;
	...
	bool Utils::LaunchProcess(
		...
		#if defined( _WIN32 ) || defined( _WIN64 )
		{
			...
			if (CreateProcessA(
				...
				std::string LastErrorString= Win32Utils::GetLastErrorAsString();
